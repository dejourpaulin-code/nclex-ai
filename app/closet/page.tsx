...
const ITEM_CATALOG: Record<string, CatalogItem[]> = {
  scrubs: [
    ...
    { key: "scrubs-navy",     label: "Navy Scrubs",     tier: "unlock",  unlockDesc: "25 questions" },
    { key: "scrubs-blue",     label: "Blue Scrubs",     tier: "unlock",  unlockDesc: "50 questions" },
    { key: "scrubs-red",      label: "Red Scrubs",      tier: "unlock",  unlockDesc: "75 questions" },
    { key: "scrubs-gray",     label: "Gray Scrubs",     tier: "unlock",  unlockDesc: "100 questions" },
    { key: "scrubs-maroon",   label: "Maroon Scrubs",   tier: "unlock",  unlockDesc: "125 questions" },
    { key: "scrubs-green",    label: "Green Scrubs",    tier: "unlock",  unlockDesc: "150 questions" },
    { key: "scrubs-purple",   label: "Purple Scrubs",   tier: "unlock",  unlockDesc: "175 questions" },
    { key: "scrubs-black",    label: "Black Scrubs",    tier: "unlock",  unlockDesc: "200 questions" },
    { key: "scrubs-pink",     label: "Pink Scrubs",     tier: "unlock",  unlockDesc: "225 questions" },
    { key: "scrubs-white",    label: "White Scrubs",    tier: "unlock",  unlockDesc: "250 questions" },
    { key: "scrubs-teal",     label: "Teal Scrubs",     tier: "unlock",  unlockDesc: "300 questions" },
    { key: "scrubs-coral",    label: "Coral Scrubs",    tier: "unlock",  unlockDesc: "350 questions" },
    { key: "scrubs-lavender", label: "Lavender Scrubs", tier: "unlock",  unlockDesc: "400 questions" },
    { key: "scrubs-mint",     label: "Mint Scrubs",     tier: "unlock",  unlockDesc: "450 questions" },
    { key: "scrubs-burgundy", label: "Burgundy Scrubs", tier: "unlock",  unlockDesc: "500 questions" },
    { key: "scrubs-olive",    label: "Olive Scrubs",    tier: "unlock",  unlockDesc: "550 questions" },
    { key: "scrubs-yellow",   label: "Yellow Scrubs",   tier: "unlock",  unlockDesc: "600 questions" },
    { key: "scrubs-crimson",  label: "Crimson Scrubs",  tier: "unlock",  unlockDesc: "650 questions" },
    { key: "scrubs-sky",      label: "Sky Scrubs",      tier: "unlock",  unlockDesc: "700 questions" },
    { key: "scrubs-indigo",   label: "Indigo Scrubs",   tier: "unlock",  unlockDesc: "750 questions" },
    { key: "scrubs-rose",     label: "Rose Scrubs",     tier: "unlock",  unlockDesc: "800 questions" },
    { key: "scrubs-lime",     label: "Lime Scrubs",     tier: "unlock",  unlockDesc: "850 questions" },
    { key: "scrubs-amber",    label: "Amber Scrubs",    tier: "unlock",  unlockDesc: "900 questions" },
    { key: "scrubs-gold",     label: "Gold Scrubs",     tier: "unlock",  unlockDesc: "95% accuracy" },
  ],
  hat: [
    { key: "hat-nurse-cap",      label: "Nurse Cap",        tier: "starter", unlockDesc: null },
    { key: "hat-surgical-cap",   label: "Surgical Cap",     tier: "unlock",  unlockDesc: "15 questions or 10-streak" },
    { key: "hat-scrub-cap-teal", label: "Teal Scrub Cap",   tier: "unlock",  unlockDesc: "35 questions" },
    { key: "hat-scrub-cap-purple", label: "Purple Scrub Cap", tier: "unlock", unlockDesc: "55 questions" },
    { key: "hat-scrub-cap-pink", label: "Pink Scrub Cap",   tier: "unlock",  unlockDesc: "90 questions" },
    { key: "hat-beanie",         label: "Cozy Beanie",      tier: "unlock",  unlockDesc: "120 questions" },
    { key: "hat-beret",          label: "Beret",            tier: "unlock",  unlockDesc: "160 questions" },
    { key: "hat-grad-cap",       label: "Graduation Cap",   tier: "unlock",  unlockDesc: "250 questions" },
    { key: "hat-crown",          label: "Crown",            tier: "unlock",  unlockDesc: "500 questions" },
    { key: "hat-cat-ears",       label: "Cat Ears",         tier: "unlock",  unlockDesc: "700 questions" },
    { key: "hat-santa",          label: "Santa Hat",        tier: "unlock",  unlockDesc: "900 questions" },
    { key: "hat-flower-crown",   label: "Flower Crown",     tier: "unlock",  unlockDesc: "80% accuracy" },
    { key: "hat-halo",           label: "Halo",             tier: "unlock",  unlockDesc: "90% accuracy" },
  ],
  badge: [
    { key: "badge-blue",     label: "Blue Badge",     tier: "starter", unlockDesc: null },
    { key: "badge-green",    label: "Green Badge",    tier: "unlock",  unlockDesc: "10 questions" },
    { key: "badge-red",      label: "Red Badge",      tier: "unlock",  unlockDesc: "30 questions" },
    { key: "badge-teal",     label: "Teal Badge",     tier: "unlock",  unlockDesc: "60 questions" },
    { key: "badge-orange",   label: "Orange Badge",   tier: "unlock",  unlockDesc: "80 questions" },
    { key: "badge-purple",   label: "Purple Badge",   tier: "unlock",  unlockDesc: "100 questions" },
    { key: "badge-black",    label: "Black Badge",    tier: "unlock",  unlockDesc: "150 questions" },
    { key: "badge-silver",   label: "Silver Badge",   tier: "unlock",  unlockDesc: "200 questions" },
    { key: "badge-maroon",   label: "Maroon Badge",   tier: "unlock",  unlockDesc: "300 questions" },
    { key: "badge-gold",     label: "Gold Badge",     tier: "unlock",  unlockDesc: "350 questions or 90% accuracy" },
    { key: "badge-navy",     label: "Navy Badge",     tier: "unlock",  unlockDesc: "400 questions" },
    { key: "badge-pink",     label: "Pink Badge",     tier: "unlock",  unlockDesc: "450 questions" },
    { key: "badge-emerald",  label: "Emerald Badge",  tier: "unlock",  unlockDesc: "500 questions" },
    { key: "badge-crimson",  label: "Crimson Badge",  tier: "unlock",  unlockDesc: "75% accuracy" },
    { key: "badge-platinum", label: "Platinum Badge", tier: "unlock",  unlockDesc: "95% accuracy" },
  ],
  stethoscope: [
    { key: "stethoscope-blue",      label: "Blue Stethoscope",      tier: "starter", unlockDesc: null },
    { key: "stethoscope-silver",    label: "Silver Stethoscope",    tier: "unlock",  unlockDesc: "25 questions" },
    { key: "stethoscope-orange",    label: "Orange Stethoscope",    tier: "unlock",  unlockDesc: "40 questions" },
    { key: "stethoscope-red",       label: "Red Stethoscope",       tier: "unlock",  unlockDesc: "60 questions" },
    { key: "stethoscope-green",     label: "Green Stethoscope",     tier: "unlock",  unlockDesc: "90 questions" },
    { key: "stethoscope-purple",    label: "Purple Stethoscope",    tier: "unlock",  unlockDesc: "120 questions" },
    { key: "stethoscope-teal",      label: "Teal Stethoscope",      tier: "unlock",  unlockDesc: "160 questions" },
    { key: "stethoscope-black",     label: "Black Stethoscope",     tier: "unlock",  unlockDesc: "210 questions" },
    { key: "stethoscope-navy",      label: "Navy Stethoscope",      tier: "unlock",  unlockDesc: "260 questions" },
    { key: "stethoscope-white",     label: "White Stethoscope",     tier: "unlock",  unlockDesc: "320 questions" },
    { key: "stethoscope-coral",     label: "Coral Stethoscope",     tier: "unlock",  unlockDesc: "380 questions" },
    { key: "stethoscope-crimson",   label: "Crimson Stethoscope",   tier: "unlock",  unlockDesc: "440 questions" },
    { key: "stethoscope-gold",      label: "Gold Stethoscope",      tier: "unlock",  unlockDesc: "500 questions" },
    { key: "stethoscope-pink",      label: "Pink Stethoscope",      tier: "unlock",  unlockDesc: "70% accuracy" },
    { key: "stethoscope-rose-gold", label: "Rose Gold Stethoscope", tier: "unlock",  unlockDesc: "80% accuracy" },
  ],
};
